...
public class DireccionController {
    ...
    @PostMapping
    public ResponseEntity<String> crearDireccion(@RequestBody AgregarDireccion direccionRequest,Principal principal) {
        String rut_usuario = principal.getName();
        direccionService.agregarDireccion(direccionRequest, rut_usuario);
